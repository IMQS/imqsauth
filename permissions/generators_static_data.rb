...
export class Permission {
	...
	constructor(id: string, name: string, friendlyName: string, description: string, module: string) {
		if (!authModuleExist(module))
			throw new Error(`Failed to create new permission '${name}'. '${module}' is not a registered module`);
