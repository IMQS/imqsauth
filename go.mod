...
require (
	...
	github.com/IMQS/authaus v1.0.14-0.20210128123100-344d9e9c37d8
	...
	github.com/IMQS/serviceauth v1.0.3
	github.com/IMQS/serviceconfigsgo v1.0.3
	github.com/IMQS/yfws v0.0.0-20180530075311-4b6350056267
